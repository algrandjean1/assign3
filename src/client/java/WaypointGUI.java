 ...
 * @see <a href="http://pooh.poly.asu.edu/Cst420">Ser321 Home Page</a>
...
public class WaypointGUI extends JFrame {
   ...
   /**
    * toWps is the JComboBox just below the from combo box
   ...
   protected JButton exportToJSON;
   ...
   public WaypointGUI(String title) {
      ...
      exportToJSON = new JButton("Export To JSON");
      exportToJSON.setBounds(20, 220, 180, 25);
      exportToJSON.setActionCommand("exportToJSON");
      getContentPane().add(exportToJSON);
